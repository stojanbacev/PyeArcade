...
void netMgr_handleRoot() {
  ...
  String currentBoardId = netMgr_preferences.getString("boardId", "swipe_strike_1");
  netMgr_preferences.end();
  
  html += "<label>Board ID:</label><br>";
  html += "<input type='text' name='boardId' value='" + currentBoardId + "' placeholder='e.g. swipe_strike_2'><br>";
